...
void World::loadTextures()
{
	try
	{
		textures.load(Texture::PlayerDie, "Textures/bunny-Sheet-die.png");
		textures.load(Texture::PlayerIdle, "Textures/bunny-Sheet.png");
		textures.load(Texture::PlayerMove, "Textures/run_sheet-1.png");
		textures.load(Texture::PlayerJump, "Textures/jump_sheet-1.png");
		textures.load(Texture::PlayerFall, "Textures/bunny-Sheet-fall.png");
		textures.load(Texture::PlayerCrouch, "Textures/bunny-Sheet-crouch.png");
		textures.load(Texture::Platform, "Textures/platform-1.png");
		...
		textures.load(Texture::Background, "Textures/background-1.png");
	}
	catch (...)
	{
		throw;
...
void World::addObject(Player * newPlayer)
{
	...
	mPlayer->addAnimation(Animation::Type::Move, textures.get(Texture::ID::PlayerMove), sf::Time(sf::seconds(0.5f)), 4, true);
	mPlayer->addAnimation(Animation::Type::Fall, textures.get(Texture::ID::PlayerFall), sf::Time(sf::seconds(0.5f)), 2, true);
	mPlayer->addAnimation(Animation::Type::Jump, textures.get(Texture::ID::PlayerJump), sf::Time(sf::seconds(0.76f)), 5, false);
